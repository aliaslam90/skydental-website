import svgPaths from "./svg-18mo9mfm73";
  ...
  return (
    <div className="bg-[#cbff8f] content-stretch flex items-center justify-center px-[14px] py-[4px] relative rounded-[100px] shrink-0">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-nowrap">
        <p className="leading-[1.55]">Contact</p>
      </div>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full">
      <p className="font-['Gilda_Display:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[48px] text-black text-center tracking-[-1.44px] w-full">Sky Dental Center</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      ...
      <div className="font-['Arial:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1b1b1b] text-[18px] text-center w-full">
        <p className="mb-0">{`We're here to answer your questions and help you schedule your appointment.`}</p>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p14548f00} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p17781bc0} id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#cbff8f] content-stretch flex gap-[8px] h-full items-center overflow-clip px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Background+Shadow">
      ...
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Quick Response</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow1() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex gap-[8px] h-full items-center overflow-clip px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Background+Shadow">
      <Svg1 />
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Professional Support</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow2() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex gap-[8px] h-full items-center overflow-clip px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Background+Shadow">
      <Svg2 />
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Easy Booking</p>
      </div>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[calc(50%+0.41px)] top-[140px] translate-x-[-50%] w-[1262.83px]">
      <Frame32 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black text-center text-nowrap">
        <p className="leading-[48px]">Get In Touch</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[23px] items-center relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[29.25px]">Choose the most convenient way to reach us. Our team is ready to assist you.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          <path d={svgPaths.pb915f30} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Margin() {
  return (
    <div className="h-[88px] relative shrink-0 w-[212px]" data-name="Margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center pb-[24px] pt-0 px-[74px] relative size-full">
        <BackgroundShadow3 />
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap">
        <p className="leading-[32px]">Phone</p>
      </div>
    </div>
  );
}
...
function Margin1() {
  return (
    <div className="relative shrink-0 w-[212px]" data-name="Margin">
...
function Container6() {
  return (
    <div className="opacity-70 relative shrink-0 w-[212px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative w-full">
        <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[20px] not-italic relative shrink-0 text-[12px] text-black text-center text-nowrap">
          <p className="mb-0">Call us for appointments or</p>
          <p>inquiries</p>
        </div>
      </div>
    </div>
...
function BackgroundBorder() {
  return (
    <div className="basis-0 bg-[#e0edff] grow h-full min-h-px min-w-px relative rounded-[24px] shrink-0" data-name="Background+Border">
...
function Container10() {
  return (
    <div className="opacity-70 relative shrink-0 w-[212px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative w-full">
        <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center text-nowrap">
          <p className="leading-[20px]">Send us a message anytime</p>
        </div>
      </div>
    </div>
  );
...
function Svg5() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          <path d={svgPaths.p3ae94df2} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d={svgPaths.p363c980} id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap">
        <p className="leading-[32px]">Location</p>
      </div>
    </div>
  );
}
...
function Margin5() {
  return (
    <div className="relative shrink-0 w-[212px]" data-name="Margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pb-[16px] pt-0 px-0 relative w-full">
        <Container13 />
      </div>
    </div>
  );
...
function Container14() {
  return (
    <div className="opacity-70 relative shrink-0 w-[212px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative w-full">
        <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center text-nowrap">
          <p className="leading-[20px]">Visit us at our modern facility</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          ...
          <path d="M16 8V16L21.3333 18.6667" id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap">
        <p className="leading-[32px]">Working Hours</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Friday: Closed</p>
      </div>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="opacity-70 relative shrink-0 w-[212px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative w-full">
        <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center text-nowrap">
          <p className="leading-[20px]">{`We're here when you need us`}</p>
        </div>
      </div>
    </div>
  );
...
function Container20() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[48px] items-start max-w-[inherit] px-[32px] py-0 relative w-full">
        <Container2 />
        <Container19 />
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start px-[80px] py-[40px] relative w-full">
          <Container20 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-center not-italic relative shrink-0 text-center w-[1259px]">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] min-w-full relative shrink-0 text-[48px] text-black tracking-[-1.44px] w-[min-content]">
        <p className="leading-[1.2]">Send Us a Message</p>
      </div>
      <p className="font-['Arial:Regular',sans-serif] leading-[28px] relative shrink-0 text-[#1f1f1f] text-[16px] text-nowrap">Fill out the form below and our team will get back to you within 24 hours.</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap">
  ...
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start justify-center px-[18px] py-[17px] relative w-full">
          <Container21 />
        </div>
      </div>
...
function Container22() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[84px] items-start relative shrink-0 w-[388px]" data-name="Container">
      <Label />
      <Input />
    </div>
  );
...
function Label3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap">
        <p className="leading-[24px]">Subject *</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip px-0 py-px relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-black text-nowrap">
          <p className="leading-[17px]">Select a subject</p>
        </div>
      </div>
    </div>
  );
...
function Options() {
  return (
    <div className="bg-[#efefef] relative rounded-[12px] shrink-0 w-full" data-name="Options">
      <div aria-hidden="true" className="absolute border-2 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center pl-[22px] pr-[34px] py-[14px] relative w-full">
          <Container27 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#9ca3af] text-[15px] text-nowrap">
          <p className="leading-[24px]">Tell us how we can help you...</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Textarea">
      <div className="flex flex-row justify-center overflow-auto size-full">
        <div className="content-stretch flex items-start justify-center pb-[134px] pt-[14px] px-[18px] relative w-full">
          <Container29 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function Container30() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start pb-[15px] pt-0 px-0 relative shrink-0 w-full" data-name="Container">
      <Label4 />
      <Textarea />
    </div>
  );
...
function Frame2() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[18px]" data-name="Frame">
      <div className="absolute inset-[8.32%_8.32%_8.33%_8.34%]" data-name="Vector">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5017 16.5017">
            <path d={svgPaths.p2528a80} id="Vector" stroke="var(--stroke-0, #CBFF8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[8.95%_8.95%_45.47%_45.47%]" data-name="Vector">
        <div className="absolute inset-[-9.14%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.705 9.70425">
            <path d="M8.955 0.75L0.75 8.95425" id="Vector" stroke="var(--stroke-0, #CBFF8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Svg7() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-center left-[7px] overflow-clip size-[18px] top-[9px]" data-name="SVG">
      <Frame2 />
    </div>
  );
}
    ...
    <div className="bg-[#cbff8f] relative rounded-[35px] shrink-0 w-full" data-name="Btn">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[24px] pr-[10px] py-[8px] relative w-full">
          <p className="font-['Arial:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#97c4ff] text-[16px] text-nowrap">Send Message</p>
          <Square1 />
        </div>
      </div>
    </div>
...
function Container31() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[12px] text-center text-nowrap">
        <p className="leading-[20px]">* Required fields</p>
      </div>
    </div>
  );
}
...
function Form() {
  return (
    <div className="bg-white relative rounded-[24px] shrink-0 w-full" data-name="Form">
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-[900px]">
      <Frame15 />
      <Form />
    </div>
  );
...
function Heading5() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black text-center text-nowrap">
        <p className="leading-[48px]">Visit Our Clinic</p>
      </div>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="content-stretch flex flex-col items-center max-w-[768px] relative shrink-0 w-[768px]" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[29.25px] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="mb-0">Located in the heart of Abu Dhabi, our modern facility is easily accessible and equipped with</p>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black w-full">
        <p className="leading-[32px]">Our Address</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[11.25px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <Heading6 />
      <Container34 />
    </div>
  );
...
function Container36() {
  return (
    <div className="relative shrink-0 w-[516px]" data-name="Container">
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-white relative rounded-[24px] shrink-0 w-full" data-name="Background+Border+Shadow">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[26px] relative w-full">
          <Container36 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-solid border-white inset-0 pointer-events-none rounded-[24px]" />
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="SVG">
          <path d="M3 11L22 2L13 21L11 13L3 11Z" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Heading7() {
  return (
    <div className="relative shrink-0 w-[516px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center relative w-full">
        ...
        <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black text-nowrap">
          <p className="leading-[32px]">Getting Here</p>
        </div>
      </div>
    </div>
  );
...
function Svg10() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p382997c0} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2ad65a80} id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M7.5 14.1667H12.5" id="Vector_3" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3849af00} id="Vector_4" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Background() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex items-center justify-center relative rounded-[12px] shrink-0 size-[40px]" data-name="Background">
      <Svg10 />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap">
        <p className="leading-[24px]">By Car</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-nowrap">
        <p className="leading-[20px]">Ample parking available on-site</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start min-w-[194.55999755859375px] relative shrink-0" data-name="Container">
      <Container37 />
      <Container38 />
    </div>
  );
...
function Svg11() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d="M6.66667 5V10" id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M12.5 5V10" id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M1.66667 10H18" id="Vector_3" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p149c2700} id="Vector_4" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.pce04cf0} id="Vector_5" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M7.5 15H11.6667" id="Vector_6" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1791ac80} id="Vector_7" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container41() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap">
        <p className="leading-[24px]">Public Transport</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-nowrap">
        <p className="leading-[20px]">Accessible by bus and taxi</p>
      </div>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start min-w-[164.97999572753906px] relative shrink-0" data-name="Container">
      <Container41 />
      <Container42 />
    </div>
  );
...
function Svg12() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p4c7fe80} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2ac70700} id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.pe14d980} id="Vector_3" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1719626f} id="Vector_4" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1a4dd00} id="Vector_5" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container45() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap">
        <p className="leading-[24px]">Accessibility</p>
      </div>
    </div>
  );
}
...
function Container46() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-nowrap">
        <p className="leading-[20px]">Wheelchair accessible entrance</p>
      </div>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start min-w-[197.66000366210938px] relative shrink-0" data-name="Container">
      <Container45 />
      <Container46 />
    </div>
  );
...
function BackgroundBorderShadow1() {
  return (
    <div className="bg-white relative rounded-[24px] shrink-0 w-full" data-name="Background+Border+Shadow">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center justify-center p-[26px] relative w-full">
          <Heading7 />
          <Container49 />
        </div>
      </div>
...
function Btn2() {
  return (
    <div className="bg-[#cbff8f] relative rounded-[35px] shrink-0 w-full" data-name="Btn">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[24px] pr-[10px] py-[8px] relative w-full">
          <p className="font-['Arial:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#97c4ff] text-[16px] text-nowrap">Get Directions on Google Maps</p>
          <Square2 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[48px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="SVG">
          <path d={svgPaths.p30cd2b80} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
          <path d={svgPaths.pd151bb0} id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
        </g>
      </svg>
    </div>
  );
...
function BackgroundShadow8() {
  return (
    <div className="absolute bg-[#cbff8f] content-stretch flex items-center justify-center left-[calc(50%+0.01px)] overflow-clip rounded-[9999px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] size-[96px] top-[32px] translate-x-[-50%]" data-name="Background+Shadow">
      <Svg14 />
    </div>
  );
}
...
function Container51() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-[32px] right-[32px] top-[152px]" data-name="Container">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[30px] text-black text-center text-nowrap">
        <p className="leading-[36px]">Sky Dental Center</p>
      </div>
    </div>
  );
}
...
function Container53() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Interactive Map Coming Soon</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow9() {
  return (
    <div className="absolute bg-[#cbff8f] content-stretch flex gap-[8px] items-center left-[calc(50%+0.1px)] overflow-clip px-[24px] py-[12px] rounded-[9999px] top-[252px] translate-x-[-50%]" data-name="Background+Shadow">
      <div className="bg-[#97c4ff] rounded-[9999px] shrink-0 size-[12px]" data-name="Background" />
      <Container53 />
    </div>
  );
}
...
function Container54() {
  return (
    <div className="h-[328px] relative shrink-0 w-[328.81px]" data-name="Container">
      <BackgroundShadow8 />
      <Container51 />
      <Container52 />
      <BackgroundShadow9 />
...
function Background3() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[568px]" data-name="Background" style={{ backgroundImage: "linear-gradient(134.204deg, rgb(224, 237, 255) 0%, rgb(255, 255, 255) 50%, rgba(203, 255, 143, 0.3) 100%)" }}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute bg-[rgba(203,255,143,0.2)] blur-[20px] filter left-[40px] rounded-[9999px] size-[128px] top-[40px]" data-name="Overlay+Blur" />
        <div className="absolute bg-[rgba(12,0,96,0.1)] blur-[20px] bottom-[40px] filter right-[40px] rounded-[9999px] size-[160px]" data-name="Overlay+Blur" />
        <div className="absolute inset-[-0.13px_0_0.13px_0] opacity-5" data-name="Gradient" style={{ backgroundImage: "linear-gradient(rgb(12, 0, 96) 2%, rgba(12, 0, 96, 0) 2%), linear-gradient(90deg, rgb(12, 0, 96) 2%, rgba(12, 0, 96, 0) 2%)" }} />
        <Container54 />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative">
        <Svg15 />
        <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-nowrap">
          <p className="leading-[20px]">Prime Location</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorderShadow2() {
  return (
    <div className="absolute bg-[#cbff8f] right-[31.14px] rounded-[9999px] top-[32px]" data-name="Background+Border+Shadow">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip px-[24px] py-[12px] relative rounded-[inherit]">
        <Container55 />
      </div>
    </div>
  );
...
function OverlayBorderShadow() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0)] grow h-[600px] min-h-px min-w-px relative rounded-[24px] shrink-0" data-name="Overlay+Border+Shadow">
      ...
      <div aria-hidden="true" className="absolute border-8 border-solid border-white inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="[grid-area:1_/_1] bg-[#e0edff] content-stretch flex flex-col gap-[80px] items-center justify-center ml-0 mt-0 overflow-clip p-[48px] relative rounded-[25px] w-[1390px]">
      <Frame16 />
      <Container57 />
    </div>
  );
...
export default function ContactUs() {
  return (
    <div className="bg-white content-stretch flex items-center p-[25px] relative size-full" data-name="Contact Us">
      <Frame14 />
    </div>
  );
}