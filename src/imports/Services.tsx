import svgPaths from "./svg-yya2n7n9r8";
import imgRectangle161125373 from "figma:asset/531a2b1be40c3f390e42e72de4c6233edf51733e.png";
import imgImage from "figma:asset/bad2f27ff5079a0e6ec2492bdc6955e6b191903e.png";
import imgImage1 from "figma:asset/958080d80a0502b2239e7bf8312770b39e189c59.png";
import imgImage2 from "figma:asset/c428fe717bbbc4d96b0993d331398a01e16a965a.png";
import imgImage3 from "figma:asset/e2295a1a1a2bc348414dcc117de577c691164137.png";
import imgImage4 from "figma:asset/c5fbf2bb2ed01ea6f6ce38835da33519e2db95fe.png";
import imgImage5 from "figma:asset/27cea6501d6677b5b8f9f08502ce76c7a193f7f8.png";
      ...
      <div className="absolute inset-[8.33%_8.32%_8.33%_8.34%]" data-name="Vector">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.667 14.667">
            <path d={svgPaths.p2ae0b200} fill="var(--fill-0, white)" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[12.5%_16.67%_70.83%_83.33%]" data-name="Vector">
        <div className="absolute inset-[-25%_-0.67px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.33333 4">
            <g id="Vector">
              <path d="M0.666667 0.666667V3.33333Z" fill="var(--fill-0, white)" />
              <path d="M0.666667 0.666667V3.33333" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </g>
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[79.17%] left-3/4 right-[8.33%] top-[20.83%]" data-name="Vector">
        <div className="absolute inset-[-0.67px_-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 1.33333">
            <g id="Vector">
              <path d="M3.33333 0.666667H0.666667Z" fill="var(--fill-0, white)" />
              <path d="M3.33333 0.666667H0.666667" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </g>
          </svg>
        </div>
      </div>
      <div className="absolute inset-[70.83%_83.33%_20.83%_16.67%]" data-name="Vector">
        <div className="absolute inset-[-50%_-0.67px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.33333 2.66667">
            <g id="Vector">
              <path d="M0.666667 0.666667V2Z" fill="var(--fill-0, white)" />
              <path d="M0.666667 0.666667V2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </g>
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-[12.5%] right-[79.17%] top-3/4" data-name="Vector">
        <div className="absolute inset-[-0.67px_-50%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.66667 1.33333">
            <g id="Vector">
              <path d="M2 0.666667H0.666667Z" fill="var(--fill-0, white)" />
              <path d="M2 0.666667H0.666667" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </g>
          </svg>
        </div>
      </div>
...
function SvgMargin() {
  return (
    <div className="content-stretch flex flex-col h-[16px] items-start pl-0 pr-[8px] py-0 relative shrink-0 w-[24px]" data-name="SVG:margin">
      <Svg />
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(203,255,143,0.3)] content-stretch flex gap-[8px] items-center px-[17px] py-[9px] relative rounded-[9999px] shrink-0" data-name="+BackgroundColor">
      ...
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14.001px] text-black text-nowrap">
        <p className="leading-[20px]">World-Class Dental Care</p>
      </div>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-full">
      <BackgroundColor />
      <p className="font-['Gilda_Display:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[48px] text-black text-center text-nowrap tracking-[-1.44px]">Treatment and Restoration of Teeth</p>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <Frame31 />
      <p className="font-['Arial:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1b1b1b] text-[18px] text-center w-full">We provide a full range of first-class dental services for adults and children using innovative digital equipment to ensure your comfort and perfect results.</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[16px] top-0" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_43_2160)" id="Frame">
          <path d={svgPaths.p2d09d900} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
...
function BackgroundColor1() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[17px] py-[9px] relative rounded-[9999px] shrink-0" data-name="+BackgroundColor">
      ...
      <Svg1 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14.001px] text-black text-nowrap">
        <p className="leading-[20px]">What We Do</p>
      </div>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center relative shrink-0 w-full">
      <BackgroundColor1 />
      <p className="capitalize font-['Gilda_Display:Regular',sans-serif] leading-[1.2] min-w-full not-italic relative shrink-0 text-[48px] text-black text-center tracking-[-1.44px] w-[min-content]">Our Services</p>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
      <Frame36 />
      <p className="font-['Arial:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1b1b1b] text-[18px] text-center w-full">Treatment and restoration of teeth at the highest level with our experienced and kind heart team.</p>
    </div>
  );
}
...
function Background() {
  return (
    <div className="bg-[#edfede] content-stretch flex items-center justify-center relative rounded-[16px] shrink-0 size-[64px]" data-name="Background">
      <Svg2 />
    </div>
  );
}
...
function Margin() {
  return (
    <div className="content-stretch flex flex-col h-[88px] items-start pb-[24px] pt-0 px-0 relative shrink-0 w-[64px]" data-name="Margin">
      <Background />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black w-full">
        <p className="leading-[32px]">General Dentistry</p>
      </div>
    </div>
  );
}
...
function Heading3Margin() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full" data-name="Heading 3:margin">
      <Heading />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
        <p className="leading-[26px]">Comprehensive dental care for healthy teeth and gums, including checkups, cleanings, and preventive treatments.</p>
      </div>
    </div>
  );
}
...
function Margin2() {
  return (
    <div className="content-stretch flex flex-col items-start pl-0 pr-[8px] py-0 relative shrink-0" data-name="Margin">
...
function Container3() {
  return (
    <div className="relative shrink-0 w-[339.33px]" data-name="Container">
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-white relative rounded-[24px] shrink-0 w-[405.33px]" data-name="Background+Border+Shadow">
      <div className="content-stretch flex flex-col items-start justify-center overflow-clip p-[33px] relative rounded-[inherit] w-full">
        <div className="absolute bg-[rgba(224,237,255,0.3)] right-[-31px] rounded-bl-full size-[128px] top-[-31px]" data-name="Overlay" />
        <Container3 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#f3f4f6] border-solid inset-0 pointer-events-none rounded-[24px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
function Svg4() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          <path d={svgPaths.p1536ae00} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d="M26.6667 4V9.33333" id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d="M29.3333 6.66667H24" id="Vector_3" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d="M5.33333 22.6667V25.3333" id="Vector_4" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black w-full">
        <p className="leading-[32px]">Cosmetic Dentistry</p>
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
        <p className="leading-[26px]">Transform your smile with advanced aesthetic treatments including whitening, veneers, and smile design.</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          ...
          <path d={svgPaths.p599bf00} id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black w-full">
        <p className="leading-[32px]">Orthodontics</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
        <p className="leading-[26px]">Straighten your teeth with modern orthodontic solutions including braces, Invisalign, and retainers.</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="relative shrink-0 w-[339.34px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <Margin6 />
        <Heading3Margin2 />
        <Margin7 />
...
function Svg8() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          <path d={svgPaths.p12922f00} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d="M20 16H20.0133" id="Vector_2" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d={svgPaths.p132def80} id="Vector_3" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d="M12 16H12.0133" id="Vector_4" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black w-full">
        <p className="leading-[32px]">Pediatric Dentistry</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[26px] not-italic relative shrink-0 text-[16px] text-black w-full">
        <p className="mb-0">Gentle, specialized dental care for children with focus on prevention and education.</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Svg10() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          <path d={svgPaths.p31a6e500} id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black w-full">
        <p className="leading-[32px]">{`Advanced & Restorative`}</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
        <p className="leading-[26px]">Complex treatments for complete oral rehabilitation including implants and full mouth restoration.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#cbff8f] content-stretch flex h-[179px] items-start justify-between px-[32px] py-[25px] relative rounded-[25px] shrink-0 w-[674px]" data-name="Test01">
      ...
      <div className="relative shrink-0 size-[124px]" data-name="Image">
        <img alt="" className="block max-w-none size-full" height="124" src={imgImage} width="124" />
      </div>
    </div>
  );
}
...
function Test1() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex h-[179px] items-start justify-between px-[32px] py-[25px] relative rounded-[25px] shrink-0 w-[674px]" data-name="Test02">
      <Text1 />
      <div className="relative shrink-0 size-[124px]" data-name="Image">
        <img alt="" className="block max-w-none size-full" height="124" src={imgImage1} width="124" />
      </div>
    </div>
  );
}
...
function Test2() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex h-[179px] items-start justify-between px-[32px] py-[25px] relative rounded-[25px] shrink-0 w-[674px]" data-name="Test03">
      <Text2 />
      <div className="relative shrink-0 size-[124px]" data-name="Image">
        <img alt="" className="block max-w-none size-full" height="124" src={imgImage2} width="124" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[25px] items-start relative shrink-0 w-full" data-name="Image">
      ...
      <div className="h-[548px] relative rounded-[36px] shrink-0 w-[325px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[36px]">
          <div className="absolute bg-[#c4c4c4] inset-0 rounded-[36px]" />
          <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[36px] size-full" src={imgImage4} />
        </div>
      </div>
      <div className="h-[548px] relative rounded-[36px] shrink-0 w-[325px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[36px]">
          <div className="absolute bg-[#c4c4c4] inset-0 rounded-[36px]" />
          <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[36px] size-full" src={imgImage5} />
        </div>
      </div>
    </div>
  );
...
export default function Services1() {
  return (
    <div className="bg-white content-stretch flex items-center p-[25px] relative size-full" data-name="Services">
      <Frame13 />
    </div>
  );
}