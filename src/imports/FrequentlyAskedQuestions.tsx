import svgPaths from "./svg-7onwa8j4is";
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full">
      <p className="font-['Gilda_Display:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[48px] text-black text-center text-nowrap tracking-[-1.44px]">Frequently Asked Questions</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <Frame25 />
      <p className="font-['Arial:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1b1b1b] text-[18px] text-center w-full">{`Find answers to the most common questions about our services, treatments, and patient care. If you don't find what you're looking for, our team is always here to help.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p1db90b80} fill="var(--fill-0, #97C4FF)" id="Vector" stroke="var(--stroke-0, #97C4FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-full items-center px-[25px] py-[13px] relative rounded-[9999px] shrink-0" data-name="Background+Border+Shadow">
      ...
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Expert Answers</p>
      </div>
    </div>
  );
}
...
function BackgroundBorderShadow1() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-full items-center px-[25px] py-[13px] relative rounded-[9999px] shrink-0" data-name="Background+Border+Shadow">
      ...
      <Svg1 />
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Comprehensive Guide</p>
      </div>
    </div>
  );
}
...
function BackgroundBorderShadow2() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-full items-center px-[25px] py-[13px] relative rounded-[9999px] shrink-0" data-name="Background+Border+Shadow">
      ...
      <Svg2 />
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14px] text-center text-nowrap">
        <p className="leading-[20px]">Always Here to Help</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[18px] text-center text-nowrap">
...
function Button() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex gap-[8.4px] items-center overflow-clip px-[25.2px] py-[12.6px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container4 />
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#97c4ff] text-[14.7px] text-center text-nowrap">
        <p className="leading-[21px]">General Dentistry</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Cosmetic Dentistry</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container6 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Orthodontics</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container7 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Paediatric Dentistry</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container9 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Endodontics</p>
      </div>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container10 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Prosthodontics</p>
      </div>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold','Noto_Sans:Bold',sans-serif] justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center text-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>
...
function Button7() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container11 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Oral Surgery</p>
      </div>
    </div>
  );
}
...
function Button8() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container12 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Dental Tourism</p>
      </div>
    </div>
  );
}
...
function Button9() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center leading-[0] not-italic px-[24px] py-[12px] relative rounded-[9999px] shrink-0 text-black text-center" data-name="Button">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] h-[28px] justify-center relative shrink-0 text-[18px] w-[18px]">
        <p className="leading-[20px]">🛡️</p>
      </div>
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center relative shrink-0 text-[14px] text-nowrap">
        <p className="leading-[20px]">Insurance</p>
      </div>
    </div>
  );
}
...
function Button10() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container13 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">Loyalty Program</p>
      </div>
    </div>
  );
}
...
function Button11() {
  return (
    <div className="bg-[#e0edff] content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container14 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">
        <p className="leading-[20px]">{`Appointments & Clinic`}</p>
      </div>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-center relative shrink-0 w-[961px]">
      <Frame36 />
      <Frame37 />
      <Frame38 />
    </div>
  ...
  return (
    <div className="bg-white h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[14px] items-center pl-[14px] pr-[18px] py-[14px] relative size-full">
          <Frame3 />
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0060] text-[18px] text-nowrap">
    ...
    <div className="relative shrink-0 w-full" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center relative w-full">
        ...
        <div className="flex flex-col font-['Gilda_Display:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[30px] text-black text-nowrap">
          <p className="leading-[36px]">General Dentistry</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundHorizontalBorder() {
  return (
    <div className="bg-[#e0edff] relative shrink-0 w-[956px]" data-name="Background+HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-[0px_0px_2px] border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[18px] pt-[16px] px-[32px] relative w-full">
        <Heading />
      </div>
    </div>
  );
    ...
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="content-stretch flex flex-col items-start pl-0 pr-[16px] py-0 relative w-full">
        <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
          <p className="leading-[28px]">What should I expect during my first dental visit?</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[20px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          ...
          <path d="M10 4.16667V15.8333" id="Vector_2" stroke="var(--stroke-0, #0C0060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Background() {
  return (
    <div className="bg-[#e0edff] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[32px]" data-name="Background">
      <Svg3 />
    </div>
  );
}
...
function Button12() {
  return (
    <div className="relative shrink-0 w-full" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-between p-[24px] relative w-full">
        <Container16 />
        <Background />
      </div>
    </div>
...
function HorizontalBorder() {
  return (
    <div className="content-stretch flex flex-col items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="HorizontalBorder">
...
function Container17() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="content-stretch flex flex-col items-start pl-0 pr-[16px] py-0 relative w-full">
        <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
          <p className="leading-[28px]">How often should I have a dental check-up and cleaning?</p>
        </div>
      </div>
    </div>
  );
...
function Container18() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="content-stretch flex flex-col items-start pl-0 pr-[16px] py-0 relative w-full">
        <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full">
          <p className="leading-[28px]">Do tooth-coloured fillings last long?</p>
        </div>
      </div>
    </div>
  );
...
function Container19() {
  return (
    <div className="relative shrink-0 w-[956px]" data-name="Container">
...
function BackgroundBorderShadow3() {
  return (
    <div className="bg-white relative rounded-[24px] shrink-0 w-full" data-name="Background+Border+Shadow">
      ...
      <div aria-hidden="true" className="absolute border-2 border-[#f3f4f6] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center justify-center relative shrink-0" data-name="Container">
      <Frame39 />
      <Input />
...
function Section() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center px-[80px] py-0 relative shrink-0 w-[1440px]" data-name="Section">
      <Container20 />
    </div>
  );
}
...
export default function FrequentlyAskedQuestions() {
  return (
    <div className="bg-white content-stretch flex items-center p-[25px] relative size-full" data-name="Frequently Asked Questions">
      <Frame14 />
    </div>
  );
}