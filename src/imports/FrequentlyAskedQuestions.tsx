  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p1db90b80} fill="var(--fill-0, #0C0060)" id="Vector" stroke="var(--stroke-0, #0C0060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0C0060] text-[18px] text-center text-nowrap">
...
function Button() {
  return (
    <div className="bg-[#cbff8f] content-stretch flex gap-[8.4px] items-center overflow-clip px-[25.2px] py-[12.6px] relative rounded-[9999px] shrink-0" data-name="Button">
      <Container4 />
      <div className="flex flex-col font-['Arial:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0C0060] text-[14.7px] text-center text-nowrap">
