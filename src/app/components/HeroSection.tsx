  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 h-full flex flex-col justify-end px-[20px] md:px-[40px] lg:px-[73px] pb-[32px] md:pb-[40px] lg:pb-[48px]"
      >
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between w-full max-w-[1294px] gap-[32px] md:gap-[40px]">
          {/* Left Content */}
