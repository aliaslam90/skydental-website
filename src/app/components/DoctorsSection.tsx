    ...
    <section id="doctors" className="py-[50px] md:py-[60px] lg:py-[70px] px-[16px] md:px-[20px] lg:px-[25px] bg-[#e0edff]">
      <div className="max-w-[1390px] mx-auto">
        ...
        >
          ...
          <Link to="/our-doctors" className="bg-[#56FC8A] flex items-center gap-4 md:gap-6 pl-4 md:pl-6 pr-[8px] md:pr-[10px] py-2 rounded-[35px] hover:bg-[#B1FF57] transition-colors">
